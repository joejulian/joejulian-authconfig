...
class Facter::Util::DotD
    ...
    def initialize(dir="/etc/facts.d/authjsondump/", cache_file="/tmp/facts_cache.yml")
        @dir = dir
    ...
    def script_parser(file)
        ...
        JSON.load(result).each_pair do |f, v|
            Facter.add(f) do
                setcode { v }
            end
        end
...
Facter::Util::DotD.new("/etc/facts.d/authjsondump").create
